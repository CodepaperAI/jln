...
export const locations = [
  {
    ...
    city: "Toronto",
    blurb:
      "From downtown condos to detached garages in Etobicoke and Scarborough, Toronto floors take a beating from road salt, freeze-thaw cycles, and heavy daily use. JLN Epoxy installs seamless, easy-clean epoxy systems built to handle it.",
    areas: ["Downtown", "North York", "Etobicoke", "Scarborough", "East York"],
    faq: {
      q: "Do you install epoxy floors across Toronto?",
      a: "Yes — JLN Epoxy serves all of Toronto, including North York, Etobicoke, Scarborough, and East York, for garages, basements, and commercial spaces.",
    },
  },
  {
    slug: "mississauga",
  ...
  },
  {
    ...
    city: "Brampton",
    blurb:
      "Brampton garages and workshops benefit from a tough flake or polyaspartic coating that resists tires, salt, and spills. JLN Epoxy delivers a showroom finish that holds up to real use.",
  ...
  },
  {
    ...
    city: "Hamilton",
    blurb:
      "Hamilton's mix of older homes and industrial spaces makes epoxy a smart, durable choice. JLN Epoxy handles garages, basements, and commercial floors across the city and the Mountain.",
  ...
  },
  {
    ...
    faq: {
      ...
      a: "Yes — JLN Epoxy installs epoxy flooring throughout Burlington, including Aldershot, Alton, and Millcroft.",
    },
  },
  {
    slug: "markham",
  ...
  },
  {
    ...
    city: "Richmond Hill",
    blurb:
      "Richmond Hill garages and interiors benefit from a durable, premium epoxy finish. JLN Epoxy delivers seamless coatings that resist salt, moisture, and daily wear.",
  ...
  },
  {
    ...
    city: "Scarborough",
    blurb:
      "Scarborough garages, basements, and commercial units get a tough, seamless epoxy surface. JLN Epoxy focuses on preparation first for a floor that performs for years.",
